...
public class PrintfFormat {
	...
	int getArgumentPosition() { return this.argumentPosition; }
	...
	private void setArgPosition() {
		...
		if (this.fmt.charAt(xPos)=='$') {
			...
			Integer.parseInt(this.fmt.substring(this.pos,xPos));
		    this.pos=xPos+1;
		}
	    }
	}
	...
	private boolean setFieldWidthArgPosition() {
		...
		if (this.fmt.charAt(xPos)=='$') {
		    ...
		    this.argumentPositionForFieldWidth=
			Integer.parseInt(this.fmt.substring(this.pos,xPos));
		    this.pos=xPos+1;
		    ret=true;
		}
	...
	private void setOptionalHL() {
	    ...
	    if (this.pos < this.fmt.length()) {
		char c = this.fmt.charAt(this.pos);
		if (c=='h') { this.optionalh=true; this.pos++; }
		else if (c=='l') { this.optionall=true; this.pos++; }
		else if (c=='L') { this.optionalL=true; this.pos++; }
	    }
	}
	/**
	...
	private boolean setPrecisionArgPosition() {
		...
		if (this.fmt.charAt(xPos)=='$') {
		    ...
		    this.argumentPositionForPrecision=
			Integer.parseInt(this.fmt.substring(this.pos,xPos));
		    this.pos=xPos+1;
		    ret=true;
		}
